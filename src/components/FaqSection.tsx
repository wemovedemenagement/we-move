...
export const FaqSection: React.FC = () => {
  ...
  return (
    <section id="questions" className="py-16 sm:py-24 lg:py-28 bg-[#FFFFFF] border-b border-[#E6E8EB]/70 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <div className="space-y-3">
              ...
              <h2 className="text-[32px] sm:text-[40px] lg:text-[44px] font-bold text-[#111827] tracking-tight leading-[1.15] [text-wrap:balance]">
                Les questions utiles pour bien préparer votre projet.
              </h2>

              <p className="text-[16.5px] sm:text-[17.5px] text-[#475569] leading-relaxed">
            ...
            <div className="p-6 sm:p-7 rounded-2xl border border-[#E2E8F0] bg-[#FAFAF8] flex flex-col sm:flex-row sm:items-center justify-between gap-5 shadow-xs">
              ...
              <div className="shrink-0 flex items-center gap-3">
                <Link
                  href="/contact/"
                  className="px-4 py-2.5 rounded-xl bg-white border border-[#CBD5E1] text-[13.5px] font-semibold text-[#1E293B] hover:border-[#0082CA] hover:text-[#0082CA] transition-colors shadow-2xs"
                >
                  Poser une question
                </Link>
                <Link
                  href="/devis/"
                  className="px-4 py-2.5 rounded-xl bg-[#0082CA] text-[13.5px] font-semibold text-white hover:bg-[#006FA8] transition-colors shadow-xs"
                >
                  Demander un devis
                </Link>
              </div>
          ...
          <div className="lg:col-span-5 w-full lg:sticky lg:top-28">
            ...
            <div className="relative rounded-2xl overflow-hidden bg-white border border-[#E2E8F0] shadow-xl shadow-slate-900/5 aspect-[3/4] sm:aspect-[4/5] lg:aspect-[3/4]">
              ...
              <div className="absolute top-4 left-4 right-4 flex items-center justify-between">
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white/95 backdrop-blur-md border border-white/60 shadow-sm text-[12px] font-semibold text-[#111827]">
                  <span className="w-2 h-2 rounded-full bg-[#10B981] animate-pulse" />
                  <span>Conseils 7j/7</span>
                </div>

                <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-black/50 backdrop-blur-md border border-white/20 text-white font-mono text-[11.5px] font-semibold">
                  <span>Paris & IDF</span>
                </div>
              </div>

              {/* Bottom Reassurance Card over the image */}
              <div className="absolute bottom-4 left-4 right-4 p-4.5 rounded-xl bg-white/95 backdrop-blur-md border border-white/70 shadow-lg space-y-2.5">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[11px] font-mono font-semibold text-[#0082CA] bg-[#EBF5FB] px-2 py-0.5 rounded">
                    Ligne dédiée
                  </span>
                </div>
                ...
                <a
                  href="tel:0173743690"
                  className="flex items-center justify-between pt-2 border-t border-[#F1F5F9] text-[13px] font-bold text-[#0082CA] hover:text-[#006FA8] transition-colors"
                >
                  ...
                  <span className="text-[11px] font-semibold text-[#64748B]">Appel gratuit &rarr;</span>
                </a>
              </div>
            ...
            {/* Photo caption */}
            <p className="mt-2.5 text-[12px] text-[#64748B] text-center lg:text-right font-normal">
